...
class SDResourceLightProfile(SDResource):
    """
    A light profile resource as it can be found in a SDPackage
    """
    def __init__(self, APIContext, handle, *args, **kwargs):
        """
        Constructor

        :rtype: SDResourceLightProfile
        """
    ...
    def sNewFromFile(parent, filePath, embedMethod):
        """
        Create a new SDResourceLightProfile from the specified file. The resource may reference or copy the file content depending on the EmbedMethod
        ...
        _res = sd.getContext().SDResourceLightProfile_sNewFromFile(parent.mHandle, ctypes.create_string_buffer(filePath.encode('utf-8')), embedMethod.value, ctypes.byref(outResource))
